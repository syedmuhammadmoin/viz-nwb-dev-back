...
namespace Vizalys.Api.Controllers
{
    ...
    public class BudgetController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PaginationResponse<List<BudgetDto>>>> GetAllAsync([FromQuery] PaginationFilter filter)
        {
        ...
        [ClaimRequirement("Permission", new string[] { Permissions.BudgetClaims.View, Permissions.BudgetClaims.Delete, Permissions.BudgetClaims.Edit })]
        [HttpGet("{id:int}")]
