...
namespace Vizalys.Api.Controllers
{
    ...
    public class Level4Controller : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Level4Dto>>> GetAllAsync([FromQuery] PaginationFilter filter)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Level4Dto>> CreateAsync(CreateLevel4Dto entity)
        {
