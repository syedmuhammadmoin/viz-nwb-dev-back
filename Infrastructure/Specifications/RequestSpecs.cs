...
namespace Infrastructure.Specifications
{
    public class RequestSpecs : BaseSpecification<RequestMaster>
    {
        public RequestSpecs(List<DateTime?> docDate,
			...
			&& x.RequestDate.Month == (filter.Month != null ? Convert.ToInt32(filter.Month) : x.RequestDate.Month)
			&& x.RequestDate.Year == (filter.Year != null ? Convert.ToInt32(filter.Year) : x.RequestDate.Year)
