...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220530112414_updateVendorBillTable")]
    partial class updateVendorBillTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.TransactionReconcile", b =>
                {
                    ...
                    b.Property<int>("DocumentTransactionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocumentTransactionId");
            ...
            modelBuilder.Entity("Domain.Entities.TransactionReconcile", b =>
                {
                    b.HasOne("Domain.Entities.Transactions", "DocumentTransaction")
                        .WithMany()
                        .HasForeignKey("DocumentTransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Transactions", "PaymentTransaction")
                        .WithMany()
                        .HasForeignKey("PaymentTransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DocumentTransaction");
